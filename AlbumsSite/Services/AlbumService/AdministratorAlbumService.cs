...
{
    public class AdministratorAlbumService: BaseAlbumService
    {
        public AdministratorAlbumService(
          ...
          ) : base(IDeleteAlbumCommand, contextAccessor, parseMetaDataCommand, environment, repository, RoleName.Administrator)
        {
